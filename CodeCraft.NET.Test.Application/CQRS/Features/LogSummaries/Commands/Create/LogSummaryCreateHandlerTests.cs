...
namespace CodeCraft.NET.Test.Application.CQRS.Features.LogSummaries.Commands.Create
{
    [TestClass]
    public class LogSummaryCreateHandlerTests
    {
        private Mock<ILogSummaryRepository> _repositoryMock = null!;
        private Mock<ICodeCraftUnitOfWork> _unitOfWorkMock = null!;
        private Mock<IMapper> _mapperMock = null!;
        private Mock<ILogger<LogSummaryCreateHandler>> _loggerMock = null!;
        private LogSummaryCreateHandler _handler = null!;
        ...
        public void Setup()
        {
            ...
            _loggerMock = new Mock<ILogger<LogSummaryCreateHandler>>();
            ...
            _handler = new LogSummaryCreateHandler(_unitOfWorkMock.Object, _mapperMock.Object, _loggerMock.Object);
        }
        ...
        public async Task Handle_ValidCommand_CreatesEntityAndReturnsId()
        {
            ...
            _repositoryMock.Setup(x => x.AddEntity(It.IsAny<LogSummary>()));
            ...
            _repositoryMock.Verify(x => x.AddEntity(It.IsAny<LogSummary>()), Times.Once);
        ...
        public async Task Handle_MappingFails_PropagatesException()
        {
            ...
            _mapperMock.Verify(x => x.Map<LogSummary>(command), Times.Once);
            _repositoryMock.Verify(x => x.AddEntity(It.IsAny<LogSummary>()), Times.Never);
        ...
        public async Task Handle_CompleteReturnsZero_ThrowsException()
        {
            // Arrange
            var command = new LogSummaryCreate();
            var entity = new LogSummary { Id = 5 };
