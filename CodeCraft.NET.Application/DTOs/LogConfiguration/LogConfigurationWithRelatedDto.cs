...
namespace CodeCraft.NET.Application.DTOs.Custom.LogConfigurations
{
    /// <summary>
    /// Extended DTO for LogConfiguration with related entities
    /// This file is never regenerated, so your customizations are safe
    /// </summary>
    public partial class LogConfigurationWithRelatedDto : LogConfigurationDto
    {
        // ============================================
