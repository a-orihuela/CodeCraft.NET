...
public partial class LogSummaryWithRelatedSpecification : BaseSpecification<LogSummary>
{
    public LogSummaryWithRelatedSpecification(LogSummarySpecificationParams parameters)
        : base(x =>
