...
public partial class LogConfigurationWithRelatedSpecification : BaseSpecification<LogConfiguration>
{
    public LogConfigurationWithRelatedSpecification(LogConfigurationSpecificationParams parameters)
        : base(x =>
