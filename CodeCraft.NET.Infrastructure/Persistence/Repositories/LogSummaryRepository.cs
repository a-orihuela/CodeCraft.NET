...
{
    public partial class LogSummaryRepository : RepositoryBase<LogSummary, ApplicationDbContext>, ILogSummaryRepository
	{
        public LogSummaryRepository(ApplicationDbContext context) : base(context)
        {
        }
	}
}